...
// Example HTML content to be used for local file and HTML string.
...
// Prepare a local file with the example HTML content.
...
enum _MenuOptions {
  ...
  setCookie,
  removeCookie,
  loadFlutterAsset,  // Added new options
  loadHtmlString,
  loadLocalFile,
}
